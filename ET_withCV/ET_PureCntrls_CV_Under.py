...
fscore_df.to_csv(os.path.join(outDir, 'ET.PureCntrls.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'ET.PureCntrls.roc.Under.CV.txt'), index=None, sep='\t')
