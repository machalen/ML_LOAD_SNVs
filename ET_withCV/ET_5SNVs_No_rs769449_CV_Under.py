...
Var_TreeSelect=["rs429358","rs4420638","rs405509", "rs1160985", "rs7412"]
...
fscore_df.to_csv(os.path.join(outDir, 'ET.5SNVs.no.rs769449.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'ET.5SNVs.no.rs769449.roc.Under.CV.txt'), index=None, sep='\t')
