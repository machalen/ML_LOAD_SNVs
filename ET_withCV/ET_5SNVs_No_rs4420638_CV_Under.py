...
fscore_df.to_csv(os.path.join(outDir, 'ET.5SNVs.no.rs4420638.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'ET.5SNVs.no.rs4420638.roc.Under.CV.txt'), index=None, sep='\t')
