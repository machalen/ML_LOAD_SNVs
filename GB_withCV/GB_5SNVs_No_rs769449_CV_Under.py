...
fscore_df.to_csv(os.path.join(outDir, 'GB.5SNVs.no.rs769449.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.5SNVs.no.rs769449.roc.Under.CV.txt'), index=None, sep='\t')
