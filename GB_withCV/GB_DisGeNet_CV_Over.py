...
fscore_df.to_csv(os.path.join(outDir, 'GB.DisGeNet.fscore.Over.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.DisGeNet.roc.Over.CV.txt'), index=None, sep='\t')
