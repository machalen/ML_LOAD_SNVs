...
fscore_df.to_csv(os.path.join(outDir, 'GB.5SNVs.no.rs429358.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'GB.5SNVs.no.rs429358.roc.Under.CV.txt'), index=None, sep='\t')
