...
fscore_df.to_csv(os.path.join(outDir, 'RF.refVars.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.refVars.roc.Under.CV.txt'), index=None, sep='\t')
