...
fscore_df.to_csv(os.path.join(outDir, 'RF.refVars.fscore.Over.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.refVars.roc.Over.CV.txt'), index=None, sep='\t')
