...
fscore_df.to_csv(os.path.join(outDir, 'RF.DisGeNet.fscore.Over.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.DisGeNet.roc.Over.CV.txt'), index=None, sep='\t')
