...
Var_TreeSelect=["rs429358","rs769449", "rs405509", "rs1160985", "rs7412"]
...
fscore_df.to_csv(os.path.join(outDir, 'RF.5SNVs.no.rs4420638.fscore.Under.CV.txt'), index=None, sep='\t')
...
roc_df.to_csv(os.path.join(outDir, 'RF.5SNVs.no.rs4420638.roc.Under.CV.txt'), index=None, sep='\t')
