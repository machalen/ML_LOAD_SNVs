...
PredictVars.to_csv(os.path.join(outDir, 'RF.DisGeNet.Predictors.CV.txt'), index=None, sep='\t')
...
x_telab.to_csv(os.path.join(outDir, 'RF.DisGeNet.Samples.CV.txt'), index=None, sep='\t')
